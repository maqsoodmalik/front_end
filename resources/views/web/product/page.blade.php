                                ...
                                <div class="product-thumb row">
                                    <div class="image col-xs-12">
                                        ...
                                        <a
                                            ...
                                            src="{{ Storage::url('storage/app/'. $item->images->count() ? $item->images[0]->thumbnail : '') }}"
                                            title="Clean Silk Puff-Sleeve Shirt" alt="Clean Silk Puff-Sleeve Shirt">


                                           @if (isset($item->images[1]->thumbnail))
                                                <img class="image_thumb_swap horizontal_scrolling_left_to_right"
                                                src="{{ Storage::url('storage/app/'. $item->images->count() ? $item->images[1]->thumbnail : '') }}"
                                                title="Clean Silk Puff-Sleeve Shirt" alt="Clean Silk Puff-Sleeve Shirt">
                                           @endif
                                        </a>
